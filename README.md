...
Also availible as a single All-in-One binary in a cditools toolkit. See: [cditools: mkcdi-portable-linux](https://github.com/Conkwer/cditools/tree/main/mkcdi-portable-linux).  
