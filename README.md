...
Note: Source for cdi4dc not included in this repo. [cdi4dc linux fork](https://github.com/Conkwer/img4dc) used for ISO→CDI conversion with proper ECC/EDC (optional).
